...
@SecurityModel(operations = {}, roles = { @SecurityRole(description = "", name = RoleNames.ADMIN, operations = {
		...
		@SecurityRole(description = "", name = RoleNames.SECRATERY, operations = { "role:read", "operation:read",
				"profile:read", "profile:update", "approvals:create", "approvals:read", "approvals:update",
				"meeting:read", "meetingroom:read", "workinghour:read", "holiday:read" }),
