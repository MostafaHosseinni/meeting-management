    ...
    .directive(
        ...
        [
            ...
            function ($http, CrudUtil, UiUtil, Labels, OperationUtil) {
                ...
                directive.templateUrl = "js/component/DataTableTemplateCard.html";
                ...
                directive.link = function ($scope, elem, attr, ctrl) {
                    ...
                    $scope.tableModel.ranges = UiUtil
                        .getDefaultLocalComboModel([
                            UiUtil.getDefaultComboLocalData("6", 6),
                            UiUtil.getDefaultComboLocalData("12", 12),
                            UiUtil.getDefaultComboLocalData("18", 18),
                            UiUtil.getDefaultComboLocalData("24", 24)]);
                    ...
                    $scope.tableModel.callDataService = function () {
                        if ($scope.tableModel.customeCallDataService == undefined || $scope.tableModel.customeCallDataService == false) {
                                ...
                                .then(
                                    function (reponseData) {
                                        ...
                                        if (data == undefined) {
                                            ...
                                            if ($scope.tableModel.count != data)
                                                alertSuccess(
                                                    data + "آیتم برای جستجو یافت شد",
                                                    3000);
                                            $scope.tableModel.count = data;
...
// $scope.tableModel.paginationObject.page = 0;
                            ...
                            if ($scope.tableModel.isSearchService) {

                                CrudUtil
                                    .postSearchByPage(
                                        $scope.tableModel.entityName,
                                        $scope.tableModel.searchData,
                                        $scope.tableModel.paginationObject,
                                        $scope.tableModel.methodName)
                                    .then(
                                        function (reponseData) {
